...
import {
  ...
  export const dropListItems = {
    ...
    base: [
      // { id: 7, title: "Kassa", icon: faDatabase },
      { id: 8, title: "Mijozlar hisoboti", icon: faSync },
      { id: 9, title: "Yetkazib beruvchilar ro'yxati", icon: faFolderClosed },
       { id: 10, title: "Mijozlar ro'yxati", icon: faFolderClosed },
    ],
  };
